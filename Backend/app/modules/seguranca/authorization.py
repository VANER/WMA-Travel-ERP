...
exigir_financeiro_visualizar = exigir_permissao("FINANCEIRO_VISUALIZAR")
exigir_financeiro_operar = exigir_permissao("FINANCEIRO_OPERAR")
exigir_financeiro_aprovar = exigir_permissao("FINANCEIRO_APROVAR")
exigir_turismo_visualizar = exigir_permissao("TURISMO_VISUALIZAR")
exigir_turismo_operar = exigir_permissao("TURISMO_OPERAR")
exigir_turismo_gerenciar = exigir_permissao("TURISMO_GERENCIAR")
