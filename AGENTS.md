...
2.0.11, o Core Corporativo 2.1 e a etapa 2.2.1 estão concluídos e certificados. A etapa 2.2 — Segurança e Controle
de Acesso deve continuar pela 2.2.2 — Autenticação. Frontend React e
