...
2.0.8 estão integradas e certificadas. A etapa 2.0.9 — Testes Iniciais está certificada no PR #13 e aguarda
integração. Frontend React e aplicativo Flutter continuam planejados e não devem ser antecipados sem escopo
explícito.
