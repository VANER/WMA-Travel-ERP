...
2.0.8 estão integradas e certificadas, e a próxima etapa é a 2.0.9 — Testes Iniciais. Frontend React e aplicativo
Flutter continuam planejados e não devem ser antecipados sem escopo explícito.
