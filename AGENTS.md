...
2.0.11, o Core Corporativo 2.1, a etapa 2.2, a Governança de API 2.3, o módulo Comercial 2.4, o módulo Financeiro
2.5 e o módulo Turismo 2.6 estão concluídos, certificados e integrados à `main`. A etapa 2.7 — Bike Tour está em
`gate documental` e a implementação funcional permanece bloqueada até o inventário e a fronteira de domínio da
modalidade serem aprovados. Frontend React e aplicativo Flutter continuam planejados e não devem ser antecipados sem
escopo explícito.
