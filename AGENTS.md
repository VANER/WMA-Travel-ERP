...
2.0.11 estão integradas e certificadas; a fundação Backend/API está encerrada e a próxima etapa é a 2.1.1 —
Inventário do Core Corporativo. Frontend React e
