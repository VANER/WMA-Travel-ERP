...
2.0.7 estão integradas e certificadas, e a etapa atual é a 2.0.8 — OpenAPI. Frontend React e aplicativo Flutter
continuam planejados e não devem ser antecipados sem escopo explícito.
