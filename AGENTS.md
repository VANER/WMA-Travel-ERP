...
2.0.11 estão integradas e certificadas; a fundação Backend/API está encerrada e a etapa 2.1.1 — Inventário do
Core Corporativo está concluída e certificada no PR #21. Frontend React e
