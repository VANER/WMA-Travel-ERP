...
2.0.11, o Core Corporativo 2.1, a etapa 2.2, a Governança de API 2.3 e o módulo Comercial 2.4 estão concluídos,
certificados e integrados. As etapas funcionais foram reprogramadas pela ADR-017; a próxima execução autorizada é
2.5 — Financeiro. Frontend React e aplicativo Flutter continuam planejados e não devem ser antecipados sem escopo
explícito.
