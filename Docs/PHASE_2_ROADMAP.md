...
**Status:** EM EXECUÇÃO — etapa 2.1.6 concluída; próxima etapa 2.1.7
...
`main`. As etapas 2.1.1 a 2.1.6 do Core Corporativo estão concluídas e a execução deve continuar pelos testes.
