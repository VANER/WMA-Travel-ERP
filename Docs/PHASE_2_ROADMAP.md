...
**Status:** EM EXECUÇÃO — etapa 2.1.7 concluída; próxima etapa 2.1.8
...
`main`. As etapas 2.1.1 a 2.1.7 do Core Corporativo estão concluídas e a execução deve continuar pela certificação.
