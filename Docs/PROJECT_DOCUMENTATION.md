...
certificada; a Fase 2 está em execução, com a fundação 2.0 e as etapas 2.1.1 a 2.1.4 concluídas, certificadas e
integradas. A próxima etapa é a 2.1.5 — Schemas do Core Corporativo.
