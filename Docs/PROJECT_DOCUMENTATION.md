...
certificada; a Fase 2 está em execução, com a fundação 2.0 e as etapas 2.1.1 e 2.1.2 concluídas, certificadas e
integradas. A próxima etapa é a 2.1.3 — Repositories do Core Corporativo.
