...
API 2.3 e o Inventário Comercial 2.4.1 concluídos, certificados e integrados. A ADR-017 reprogramou as etapas
funcionais, e a execução atual é a etapa 2.4.2 — Clientes.
